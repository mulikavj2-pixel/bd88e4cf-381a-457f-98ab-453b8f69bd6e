...
export const metadata: Metadata = {
  title: "BrewHaven - Premium Coffee Shop & Specialty Beans",
  description: "Discover exceptional specialty coffee crafted with passion. Ethically sourced beans, expert baristas, and the perfect cup every time. Visit BrewHaven today.",
  keywords: "specialty coffee, premium coffee beans, coffee shop, ethically sourced, espresso, cold brew",
  metadataBase: new URL("https://brewhaven.coffee"),
  alternates: {
    canonical: "https://brewhaven.coffee"
  },
  openGraph: {
    title: "BrewHaven - Premium Coffee Shop",
    description: "Experience exceptional specialty coffee crafted with passion and sustainability",
    siteName: "BrewHaven",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765376024034-hl813z93.jpg",
        alt: "BrewHaven coffee shop"
      }
    ]
  },
  twitter: {
    ...
    title: "BrewHaven - Premium Coffee Shop",
    description: "Discover exceptional specialty coffee and ethically sourced beans",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765376024034-hl813z93.jpg"]
  },
  robots: {
    index: true,
    follow: true
